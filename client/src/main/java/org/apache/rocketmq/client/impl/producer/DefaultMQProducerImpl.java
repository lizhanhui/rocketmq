...
public class DefaultMQProducerImpl implements MQProducerInner {
    ...
    public void checkTransactionState(final String addr, final MessageExt msg,
        ...
        Runnable request = new Runnable() {
            ...
            private void processTransactionState(
                ...
                if (StringUtils.isNotEmpty(defaultMQProducer.getNamespace())) {
                    thisHeader.setNamespace(defaultMQProducer.getNamespace());
                }
        ...
        if (brokerAddr != null) {
            ...
            try {
                ...
                if (StringUtils.isNotEmpty(this.mQClientFactory.getClientConfig().getNamespace())) {
                    requestHeader.setNamespace(this.mQClientFactory.getClientConfig().getNamespace());
                }
    ...
    public void endTransaction(
        ...
        requestHeader.setProducerGroup(this.defaultMQProducer.getProducerGroup());
        if (StringUtils.isNotEmpty(this.defaultMQProducer.getNamespace())) {
            requestHeader.setNamespace(this.defaultMQProducer.getNamespace());
        }
